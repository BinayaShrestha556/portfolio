...
import projetPic3 from '../assets/Screenshot 2024-08-27 143103.png'
...
export default function Projects() {
  ...
  return (
   <div ref={ref2} className="w-full m-auto mt-20">
    ...
    <div className="flex md:w-[92%] flex-col xl:flex-row lg:w-[80%]  m-auto gap-8 w-full mt-8 lg:border-b pb-10 ">
      <div className="w-[98%] xl:w-[60%] xxl:w-[68%]  self-center bg-[rgb(255,81,0)] rounded-xl p-0.5">
        <img src={projetPic3} className='rounded-xl object-cover' alt="" />
      </div>
      ...
      <div  onMouseEnter={()=>setCursorSize(0)} onMouseLeave={()=>setCursorSize(20)} className="w-[90%] self-center xl:self-auto  border-b xl:border-none   xl:w-[40%] py-4  ">
        <AnimationComponent2 height='h-full' component={<div className='flex flex-col gap-4 xl:gap-0 justify-around h-full'>
          ...
          <p className='test-lg md:text-xl '>
            This is a full stack video streaming and sharing platform that uses ExpressJS, node.js and mongodb as a database  on the backend and uses next.js with typescript for the frontend with tailwind as a css framework. It is a complex website, allows you to do basics of youtube.  
          </p>
          <div className='w-full flex justify-around'>
          <a href='https://newtubebybinaya.vercel.app' className=" text-red hover:before:bg-redborder-[rgb(255,81,0)]  relative overflow-hidden border border-[rgb(255,81,0)] text-[rgb(255,81,0)]  transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-[rgb(255,81,0)] before:transition-all before:duration-200 hover:text-white hover:shadow-[rgb(255,81,0)] hover:before:left-0 hover:before:w-full"><p className="relative py-3 md:px-16 xl:px-3   px-6 z-10 text-sm md:text-lg">LIVE WEBSITE</p></a>
          <div onClick={()=>setButton((current)=>!current)} className=" text-white hover:before:bg-redborder-[rgb(255,81,0)] relative  overflow-hidden border border-[rgb(255,81,0)] bg-[rgb(255,81,0)]   transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-[#1A1919] before:transition-all before:duration-200 hover:text-[rgb(255,81,0)] hover:shadow-[rgb(255,81,0)] hover:before:left-0 hover:before:w-full"><p className="relative py-2  md:px-16 xl:px-3  px-6 z-10 text-sm md:text-lg">SOURCE CODE</p></div>
          {/* <a href='https://github.com/BinayaShrestha556/newtube_frontend' className=" text-white hover:before:bg-redborder-[rgb(255,81,0)] relative  overflow-hidden border border-[rgb(255,81,0)] bg-[rgb(255,81,0)]   transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-[#1A1919] before:transition-all before:duration-200 hover:text-[rgb(255,81,0)] hover:shadow-[rgb(255,81,0)] hover:before:left-0 hover:before:w-full"><p className="relative py-2  md:px-16 xl:px-3  px-6 z-10 text-sm md:text-lg">SOURCE CODE</p></a> */}
            
          </div>
  {button&&<div className='w-full flex justify-around mt-4'>
    <a href='https://github.com/BinayaShrestha556/newtube_frontend' className=" text-red hover:before:bg-redborder-[rgb(255,81,0)]  relative overflow-hidden border border-[rgb(255,81,0)] text-[rgb(255,81,0)]  transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-[rgb(255,81,0)] before:transition-all before:duration-200 rounded-xl hover:text-white hover:shadow-[rgb(255,81,0)] hover:before:left-0 hover:before:w-full"><p className="relative py-3 md:px-16 xl:px-3   px-6 z-10 text-sm md:text-lg">frontend</p></a>
    <a href='https://github.com/BinayaShrestha556/newtube_backend' className=" text-red hover:before:bg-redborder-[rgb(255,81,0)]  relative overflow-hidden border border-[rgb(255,81,0)] text-[rgb(255,81,0)]  transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-[rgb(255,81,0)] before:transition-all before:duration-200 rounded-xl hover:text-white hover:shadow-[rgb(255,81,0)] hover:before:left-0 hover:before:w-full"><p className="relative py-3 md:px-16 xl:px-3   px-6 z-10 text-sm md:text-lg">backend</p></a>
    </div>}
